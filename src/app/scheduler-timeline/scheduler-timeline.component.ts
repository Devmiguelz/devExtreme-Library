...
import { Appointment, Priority, Resource } from './models/model';

@Component({
  selector: 'app-scheduler-timeline',
  templateUrl: './scheduler-timeline.component.html',
  styleUrls: ['./scheduler-timeline.component.css']
})

export class SchedulerTimelineComponent implements OnInit {
